...
async def ask(question: str = Body(..., embed=True, max_length=6000),
    ...
    messages = [{"role": "system", "content": _SYSTEM +
                 ...
                 "hogar (sensores, históricos, facturas), la PREVISIÓN "
                 "METEOROLÓGICA diaria y HORARIA y el tiempo actual de su "
                 "localidad (weather_forecast, weather_hourly, weather_now) — "
                 "usa weather_hourly cuando pidan una hora o franja concreta "
                 "(p.ej. 9-12 h) — y los PRECIOS de la luz PVPC "
                 "de hoy y mañana (electricity_prices): úsalas siempre que la "
                 "pregunta pida datos que no estén en el contexto. NUNCA digas "
                 "que no puedes consultar el tiempo o los precios: llama a la "
                 "herramienta. Nunca menciones las herramientas al usuario. "
                 "REGLAS: las facturas "
