...
_EXTRACT_SYSTEM = (
    ...
    "'coste de gestión' o 'FEE'. OJO CON LA UNIDAD: margin_eur_kwh va SIEMPRE en "
    "€/kWh y es MENOR que 1 — si el documento lo da en €/MWh (p.ej. '3,113012 "
    "€/MWh') divide entre 1000 (→ 0.003113); si lo da en c€/kWh o cent/kWh "
    "divide entre 100.\n"
    ...
    "- FACTURAS con tabla de consumo MUY aplanada (celdas repetidas, cabeceras "
    "perdidas — típico TotalEnergies): cada línea de energía sigue la secuencia "
    "kWh → precio → importe y se identifica porque kWh × precio ≈ importe. "
    "Ejemplo real: 'P1 (Punta) P2 (Valle) … 100,19 110,81 | 0,203014 0,178791 | "
    "… 20,34 € 19,81 €' → 100,19 kWh × 0,203014 = 20,34 € ⇒ "
    "energy_p1_eur_kwh=0.203014 y el segundo par es la otra franja. El precio "
    "de energía doméstico tiene ~6 decimales y está entre 0,05 y 0,40 €/kWh; "
    "el kWh mensual por franja está entre 1 y 2000. NUNCA devuelvas null si "
    "esos pares existen. Lo mismo con potencia: 'Potencia 4,6 kW x Precio "
    "0,103156 €/kW día' → power_p1_eur_kw_day=0.103156.\n"
    "- Si el producto solo tiene DOS precios de energía (Punta y Valle, aunque "
    "los llame P1 y P2): el de Punta cubre P1 y P2 (llano) y el de Valle es P3 "
    "⇒ energy_p1=energy_p2=precio punta, energy_p3=precio valle.\n"
    "- product_name: frases tipo «Tu \"FÓRMULA LUZ HOGARES +Digital\" incluye "
    "el suministro» nombran el producto ⇒ product_name='FÓRMULA LUZ HOGARES "
    "+Digital'.\n"
